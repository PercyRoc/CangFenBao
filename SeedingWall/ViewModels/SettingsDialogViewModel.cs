...
internal class SettingsDialogViewModel : BindableBase, IDialogAware
{
    ...
    private readonly PlcSettingsViewModel _plcSettingsViewModel;
        ...
        INotificationService notificationService)
    {
        ...
        _plcSettingsViewModel = containerProvider.Resolve<PlcSettingsViewModel>();
    ...
    private void ExecuteSave()
    {
        try
        {
            ...
            _plcSettingsViewModel.SaveConfigurationCommand.Execute();
