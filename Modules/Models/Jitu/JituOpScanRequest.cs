...
{
    [JsonProperty("billcode")] public string Billcode { get; set; } = string.Empty;
    ...
    [JsonProperty("devicecode")] public string Devicecode { get; set; } = string.Empty;

    [JsonProperty("devicename")] public string Devicename { get; set; } = string.Empty;

    [JsonProperty("imgpath")] public string Imgpath { get; set; } = string.Empty;
}