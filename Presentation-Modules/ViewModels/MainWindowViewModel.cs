...
public class MainWindowViewModel : BindableBase, IDisposable
{
    ...
    public MainWindowViewModel(IDialogService dialogService,
        ...
        IAudioService audioService, ISettingsService settingsService,
    ...
    private async void OnPackageInfo(PackageInfo package)
    {
        try
        {
            ...
            _currentPackageIndex = package.Index;

            // 从服务器获取格口号
            var config = _settingsService.LoadConfiguration<Models.ModuleConfig>();
